...
static char* expiration = "*** License for c7p has expired ...\n";
...
static void addTaskSynchronized();
...
// static void *myMallocSS(char* location, int size) {
