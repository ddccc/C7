...
static char* expiration2 = "*** License for foursort has expired ...\n";
...
#include "Dsort.c"
*/
/* // include elsewhere in this setting
#include "Qusort.c"
#include "Qstack.c"
...
void *sortThread2(void *AAA) { // AAA is not used
  // int taskCnt = 0;
